<template>
    <div class="flex-container">
        ...
        <div class="social">
            <a :href="twitterLink" alt="твиттер" target="_blank" @click="shareClick('tw')">Twitter</a>
            <a :href="fbLink" alt="фейсбук" target="_blank" @click="shareClick('fb')">Facebook</a>
            <a :href="vkLink" alt="вконтакте" target="_blank" @click="shareClick('vk')">VK</a>
        </div>
    </div>
</template>
