<template>
  <div class="flex-container">
    ...
    <div class="friends-container">
      ...
      <div
        class="smileys-group"
        :class="zeroFriends ? 'sad': ''"
      />
      <div class="spacer" />
      <div
        class="friends-count"
        :class="animated ? 'animated' : ''"
        v-html="friendsCount == 0 ? 'Нисколько' : friendsCount"
      />
      <div
        class="smiley"
        :class="[animated ? 'animated' : '', zeroFriends ? 'sad' : '']"
      />
    </div>

    <div
      class="bottom-text text"
      key="text"
    >
      Представьте, сколько сможете пригласить в следующем!
    </div>
